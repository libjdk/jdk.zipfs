...
$MethodInfo _ZipPath_MethodInfo_[] = {
	{"<init>", "(Ljdk/nio/zipfs/ZipFileSystem;[B)V", nullptr, 0, $method(static_cast<void(ZipPath::*)($ZipFileSystem*,$bytes*)>(&ZipPath::init$))},
	{"<init>", "(Ljdk/nio/zipfs/ZipFileSystem;[BZ)V", nullptr, 0, $method(static_cast<void(ZipPath::*)($ZipFileSystem*,$bytes*,bool)>(&ZipPath::init$))},
	{"<init>", "(Ljdk/nio/zipfs/ZipFileSystem;Ljava/lang/String;)V", nullptr, 0, $method(static_cast<void(ZipPath::*)($ZipFileSystem*,$String*)>(&ZipPath::init$))},
	{"checkAccess", "([Ljava/nio/file/AccessMode;)V", nullptr, $TRANSIENT, $method(static_cast<void(ZipPath::*)($AccessModeArray*)>(&ZipPath::checkAccess)), "java.io.IOException"},
	{"checkPath", "(Ljava/nio/file/Path;)Ljdk/nio/zipfs/ZipPath;", nullptr, $PRIVATE, $method(static_cast<ZipPath*(ZipPath::*)($Path*)>(&ZipPath::checkPath))},
	{"compareTo", "(Ljava/nio/file/Path;)I", nullptr, $PUBLIC},
	{"compareTo", "(Ljava/lang/Object;)I", nullptr, $PUBLIC | $VOLATILE | $SYNTHETIC},
	{"copy", "(Ljdk/nio/zipfs/ZipPath;[Ljava/nio/file/CopyOption;)V", nullptr, $TRANSIENT, $method(static_cast<void(ZipPath::*)(ZipPath*,$CopyOptionArray*)>(&ZipPath::copy)), "java.io.IOException"},
	{"copyToTarget", "(Ljdk/nio/zipfs/ZipPath;[Ljava/nio/file/CopyOption;)V", nullptr, $PRIVATE | $TRANSIENT, $method(static_cast<void(ZipPath::*)(ZipPath*,$CopyOptionArray*)>(&ZipPath::copyToTarget)), "java.io.IOException"},
	{"createDirectory", "([Ljava/nio/file/attribute/FileAttribute;)V", "([Ljava/nio/file/attribute/FileAttribute<*>;)V", $TRANSIENT, $method(static_cast<void(ZipPath::*)($FileAttributeArray*)>(&ZipPath::createDirectory)), "java.io.IOException"},
	{"decode", "(C)I", nullptr, $PRIVATE | $STATIC, $method(static_cast<int32_t(*)(char16_t)>(&ZipPath::decode))},
	{"decodeUri", "(Ljava/lang/String;)Ljava/lang/String;", nullptr, $PRIVATE | $STATIC, $method(static_cast<$String*(*)($String*)>(&ZipPath::decodeUri))},
	{"delete", "()V", nullptr, 0, $method(static_cast<void(ZipPath::*)()>(&ZipPath::delete$)), "java.io.IOException"},
	{"deleteIfExists", "()V", nullptr, $PRIVATE, $method(static_cast<void(ZipPath::*)()>(&ZipPath::deleteIfExists)), "java.io.IOException"},
	{"endsWith", "(Ljava/nio/file/Path;)Z", nullptr, $PUBLIC},
	{"endsWith", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $FINAL},
	{"equals", "(Ljava/lang/Object;)Z", nullptr, $PUBLIC},
	{"equalsNameAt", "(Ljdk/nio/zipfs/ZipPath;I)Z", nullptr, $PRIVATE, $method(static_cast<bool(ZipPath::*)(ZipPath*,int32_t)>(&ZipPath::equalsNameAt))},
	{"exists", "()Z", nullptr, $PRIVATE, $method(static_cast<bool(ZipPath::*)()>(&ZipPath::exists))},
	{"getFileAttributeView", "(Ljava/lang/Class;)Ljava/nio/file/attribute/FileAttributeView;", "<V::Ljava/nio/file/attribute/FileAttributeView;>(Ljava/lang/Class<TV;>;)TV;", 0, $method(static_cast<$FileAttributeView*(ZipPath::*)($Class*)>(&ZipPath::getFileAttributeView))},
	{"getFileAttributeView", "(Ljava/lang/String;)Ljdk/nio/zipfs/ZipFileAttributeView;", nullptr, $PRIVATE, $method(static_cast<$ZipFileAttributeView*(ZipPath::*)($String*)>(&ZipPath::getFileAttributeView))},
	{"getFileName", "()Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"getFileStore", "()Ljava/nio/file/FileStore;", nullptr, 0, $method(static_cast<$FileStore*(ZipPath::*)()>(&ZipPath::getFileStore)), "java.io.IOException"},
	{"getFileSystem", "()Ljdk/nio/zipfs/ZipFileSystem;", nullptr, $PUBLIC},
	{"getName", "(I)Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"getNameCount", "()I", nullptr, $PUBLIC},
	{"getParent", "()Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"getResolved", "()[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(ZipPath::*)()>(&ZipPath::getResolved))},
	{"getResolvedPath", "()[B", nullptr, 0, $method(static_cast<$bytes*(ZipPath::*)()>(&ZipPath::getResolvedPath))},
	{"getRoot", "()Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"hashCode", "()I", nullptr, $PUBLIC},
	{"initOffsets", "()V", nullptr, $PRIVATE, $method(static_cast<void(ZipPath::*)()>(&ZipPath::initOffsets))},
	{"isAbsolute", "()Z", nullptr, $PUBLIC},
	{"isHidden", "()Z", nullptr, 0, $method(static_cast<bool(ZipPath::*)()>(&ZipPath::isHidden))},
	{"isSameFile", "(Ljava/nio/file/Path;)Z", nullptr, 0, $method(static_cast<bool(ZipPath::*)($Path*)>(&ZipPath::isSameFile)), "java.io.IOException"},
	{"iterator", "()Ljava/util/Iterator;", "()Ljava/util/Iterator<Ljava/nio/file/Path;>;", $PUBLIC},
	{"move", "(Ljdk/nio/zipfs/ZipPath;[Ljava/nio/file/CopyOption;)V", nullptr, $TRANSIENT, $method(static_cast<void(ZipPath::*)(ZipPath*,$CopyOptionArray*)>(&ZipPath::move)), "java.io.IOException"},
	{"newByteChannel", "(Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/SeekableByteChannel;", "(Ljava/util/Set<+Ljava/nio/file/OpenOption;>;[Ljava/nio/file/attribute/FileAttribute<*>;)Ljava/nio/channels/SeekableByteChannel;", $TRANSIENT, $method(static_cast<$SeekableByteChannel*(ZipPath::*)($Set*,$FileAttributeArray*)>(&ZipPath::newByteChannel)), "java.io.IOException"},
	{"newDirectoryStream", "(Ljava/nio/file/DirectoryStream$Filter;)Ljava/nio/file/DirectoryStream;", "(Ljava/nio/file/DirectoryStream$Filter<-Ljava/nio/file/Path;>;)Ljava/nio/file/DirectoryStream<Ljava/nio/file/Path;>;", 0, $method(static_cast<$DirectoryStream*(ZipPath::*)($DirectoryStream$Filter*)>(&ZipPath::newDirectoryStream)), "java.io.IOException"},
	{"newFileChannel", "(Ljava/util/Set;[Ljava/nio/file/attribute/FileAttribute;)Ljava/nio/channels/FileChannel;", "(Ljava/util/Set<+Ljava/nio/file/OpenOption;>;[Ljava/nio/file/attribute/FileAttribute<*>;)Ljava/nio/channels/FileChannel;", $TRANSIENT, $method(static_cast<$FileChannel*(ZipPath::*)($Set*,$FileAttributeArray*)>(&ZipPath::newFileChannel)), "java.io.IOException"},
	{"newInputStream", "([Ljava/nio/file/OpenOption;)Ljava/io/InputStream;", nullptr, $TRANSIENT, $method(static_cast<$InputStream*(ZipPath::*)($OpenOptionArray*)>(&ZipPath::newInputStream)), "java.io.IOException"},
	{"newOutputStream", "([Ljava/nio/file/OpenOption;)Ljava/io/OutputStream;", nullptr, $TRANSIENT, $method(static_cast<$OutputStream*(ZipPath::*)($OpenOptionArray*)>(&ZipPath::newOutputStream)), "java.io.IOException"},
	{"normalize", "()Ljava/nio/file/Path;", nullptr, $PUBLIC},
	{"normalize", "([B)[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(ZipPath::*)($bytes*)>(&ZipPath::normalize))},
	{"normalize", "([BI)[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(ZipPath::*)($bytes*,int32_t)>(&ZipPath::normalize))},
	{"normalize", "(Ljava/lang/String;)[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(ZipPath::*)($String*)>(&ZipPath::normalize))},
	{"normalize", "(Ljava/lang/String;II)[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(ZipPath::*)($String*,int32_t,int32_t)>(&ZipPath::normalize))},
	{"readAttributes", "()Ljdk/nio/zipfs/ZipFileAttributes;", nullptr, 0, $method(static_cast<$ZipFileAttributes*(ZipPath::*)()>(&ZipPath::readAttributes)), "java.io.IOException"},
	{"readAttributes", "(Ljava/lang/Class;)Ljava/nio/file/attribute/BasicFileAttributes;", "<A::Ljava/nio/file/attribute/BasicFileAttributes;>(Ljava/lang/Class<TA;>;)TA;", 0, $method(static_cast<$BasicFileAttributes*(ZipPath::*)($Class*)>(&ZipPath::readAttributes)), "java.io.IOException"},
	{"readAttributes", "(Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/util/Map;", "(Ljava/lang/String;[Ljava/nio/file/LinkOption;)Ljava/util/Map<Ljava/lang/String;Ljava/lang/Object;>;", $TRANSIENT, $method(static_cast<$Map*(ZipPath::*)($String*,$LinkOptionArray*)>(&ZipPath::readAttributes)), "java.io.IOException"},
	...
	{"resolve", "(Ljava/nio/file/Path;)Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"resolve", "([B)Ljdk/nio/zipfs/ZipPath;", nullptr, $PRIVATE, $method(static_cast<ZipPath*(ZipPath::*)($bytes*)>(&ZipPath::resolve))},
	{"resolve", "(Ljava/lang/String;)Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"resolve0", "()[B", nullptr, $PRIVATE, $method(static_cast<$bytes*(ZipPath::*)()>(&ZipPath::resolve0))},
	...
	{"setAttribute", "(Ljava/lang/String;Ljava/lang/Object;[Ljava/nio/file/LinkOption;)V", nullptr, $TRANSIENT, $method(static_cast<void(ZipPath::*)($String*,Object$*,$LinkOptionArray*)>(&ZipPath::setAttribute)), "java.io.IOException"},
	{"setGroup", "(Ljava/nio/file/attribute/GroupPrincipal;)V", nullptr, 0, $method(static_cast<void(ZipPath::*)($GroupPrincipal*)>(&ZipPath::setGroup)), "java.io.IOException"},
	{"setOwner", "(Ljava/nio/file/attribute/UserPrincipal;)V", nullptr, 0, $method(static_cast<void(ZipPath::*)($UserPrincipal*)>(&ZipPath::setOwner)), "java.io.IOException"},
	{"setPermissions", "(Ljava/util/Set;)V", "(Ljava/util/Set<Ljava/nio/file/attribute/PosixFilePermission;>;)V", 0, $method(static_cast<void(ZipPath::*)($Set*)>(&ZipPath::setPermissions)), "java.io.IOException"},
	{"setTimes", "(Ljava/nio/file/attribute/FileTime;Ljava/nio/file/attribute/FileTime;Ljava/nio/file/attribute/FileTime;)V", nullptr, 0, $method(static_cast<void(ZipPath::*)($FileTime*,$FileTime*,$FileTime*)>(&ZipPath::setTimes)), "java.io.IOException"},
	{"startsWith", "(Ljava/nio/file/Path;)Z", nullptr, $PUBLIC},
	{"startsWith", "(Ljava/lang/String;)Z", nullptr, $PUBLIC | $FINAL},
	{"subpath", "(II)Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"toAbsolutePath", "()Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC},
	{"toFile", "()Ljava/io/File;", nullptr, $PUBLIC | $FINAL},
	{"toRealPath", "([Ljava/nio/file/LinkOption;)Ljdk/nio/zipfs/ZipPath;", nullptr, $PUBLIC | $TRANSIENT, nullptr, "java.io.IOException"},
...
void ZipPath::copyToTarget(ZipPath* target, $CopyOptionArray* options) {
	...
	if (copyAttrs) {
		...
		try {
			$var($FileTime, var$2, $nc(zfas)->lastModifiedTime());
			$var($FileTime, var$3, zfas->lastAccessTime());
			$nc(view)->setTimes(var$2, var$3, $(zfas->creationTime()));
